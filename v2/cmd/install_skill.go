...
const skillName = "a2"
const skillTargetDir = ".agents/skills/a2"

var installSkillCmd = &cobra.Command{
	Use:   "install-skill",
	Short: "Устанавливает скилл a2 в ~/.agents/skills/",
	Long: `Устанавливает CLI скилл a2 для работы с фреймворком GoAperture.
Создаёт папку ~/.agents/skills/a2 и копирует туда все файлы скилла.`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		fmt.Println("Используйте: /skill:a2")
		fmt.Println("Или добавьте в PATH: export PATH=$PATH:~/.agents/skills/a2")
	},
}
...
func extractSkillFiles(skillName, targetDir string) error {
	// WalkDir работает с embed без завершающих слэшей (ReadDir("a2/") падает)
